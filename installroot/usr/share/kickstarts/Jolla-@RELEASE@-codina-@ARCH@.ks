# DisplayName: Jolla codina/@ARCH@ (release) 1
...
repo --name=adaptation0-codina-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-samsung-codina/@ARCH@/
...
%packages
@Jolla Configuration codina
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/codina
